...
def main():
    parser = argparse.ArgumentParser(description="Run inference using AIMNet2 or MACE-OFF models")
    parser.add_argument('--model_type', type=str, required=True, choices=['aimnet2', 'maceoff'],
                        help='Model type to use: aimnet2 or maceoff')
    ...
    if args.model_type == 'aimnet2':
        ...
        print(f"Running MACEOFF on dataset: {args.ds_name}")
